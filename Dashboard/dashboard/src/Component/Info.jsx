    ...
    <div className='flex flex-col md:flex-row md:items-center justify-between py-8' >
     ...
     <div className='flex items-center gap-4 md:gap-10 2xl:gap-20' >
       ...
       <IoSearchOutline className='text-xl text-gray-600 dark:text-gray-500' />
        ...
        <input placeholder='Seacrh now...' className='bg-transparent outline-none text-gray-700 dark:text-gray-500 '  />
       </div>
       <button className='flex items-center gap-2 bg-black dark:bg-violet-800 py-2 px-4 rounded-md text-white' >
