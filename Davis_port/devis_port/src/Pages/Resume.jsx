        ...
        <div className="flex m-auto flex-col lg:flex-row lg:justify-around lg:items-center gap-6">
            ...
            {experienceItems?.map((e, index) => {
              return (
                <div key={index} className="mb-6">
                  <p className="text-yellow-500 font-[490] text-3xl py-2"> {e.title} </p>
                  ...
                  <p className="text-gray-300 pv-2 flex justify-start w-[90%]"> {e.description} </p>
                </div>
              );
            })}
            <hr className="mt-4 mb-6 lg:hidden " />
          </div>
          <div> <hr className=" h-50 border h-[100vh] lg:flex hidden border-gray-500 mr-6" /></div>
          <div className="flex flex-col">
            ...
            {educationItems?.map((e, index) => {
              return (
                <div key={index} className="mb-6">
                  <p className="text-yellow-500 text-3xl font-[490] py-2 "> {e.title} </p>
                  <p className="text-gray-400 text-xl py-2 font-[400]">
                    {" "}
                    {e.date}{" "}
                  </p>
                  ...
                  <p className="text-gray-300 pv-2  w-[90%]"> {e.description} </p>
                </div>
              );
            })}
          </div>
