...
const data = [
  {
    name: "Crypto",
    account: "ddinawazalam@gmail.com",
    amount: "85,345.00",
    icon: (
  ...
  {
    name: "Paypal",
    account: "mddinawazalam@gmail.com",
    amount: "35,345.00",
    icon: (
        ...
        {data.map((item, index) => {
          return (
            ...
            >
              ...
              <div>
                <p className="text-xl text-black dark:text-green-400 font-medium"> ${item.amount} </p>
                <span className="text-xs text-gray-600 font-medium dark:font-normal dark:text-violet-700" >Account Balance</span>
              </div>
